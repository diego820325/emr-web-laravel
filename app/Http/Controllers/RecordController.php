...
class RecordController extends Controller
{
    ...
    public function store(Request $request, Patient $patient)
    {
        ...
        foreach ($request->except(['date', 'notes', 'file1', 'file2', 'file3']) as $attributeId => $formValue) {
    ...
    public function edit(Record $record)
    {
        return Inertia::render('Records/Edit', [
            'record' => $record->load(['patient', 'attachments', 'customAttributeValues.customAttribute', 'customAttributeValues.customAttributeOption']),
            'customAttributes' => CustomAttribute::where('section_id', 2)->with('options')->get(),
        ]);
    }
    ...
    public function update(Request $request, Record $record)
    {
        ...
        $record->customAttributeValues()->delete();
